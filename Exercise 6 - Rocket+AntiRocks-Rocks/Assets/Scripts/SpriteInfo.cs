...
public class SpriteInfo : MonoBehaviour 
{
    ...
    void Start () 
	{
        radius = gameObject.GetComponent<SpriteRenderer>().bounds.extents.magnitude;  //note that this does not need to be updated
        center = gameObject.GetComponent<SpriteRenderer>().bounds.center;  //note that this does need to be updated; might be better to just use transform.position 
